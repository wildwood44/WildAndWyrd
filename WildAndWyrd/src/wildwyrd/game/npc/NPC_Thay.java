...
public class NPC_Thay extends NPC {
	...
	public void setDialogue() {
		...
		dialogues[8][4] = new Dialoge("Thay", "So unforgivable, that along with his underling, all humans became hated by creatures great and small.",1);
		dialogues[8][5] = new Dialoge("Alder","But why?",1);
		dialogues[8][6] = new Dialoge("Alder","What did we do?",1);
		dialogues[8][7] = new Dialoge("Thay", "For your part.",1);
		dialogues[8][8] = new Dialoge("Thay", "Nothing.",1);
		dialogues[8][9] = new Dialoge("Thay", "But that didn't matter to those who had lost friends and family in the conflict.",1);
