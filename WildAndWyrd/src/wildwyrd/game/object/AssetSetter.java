...
public class AssetSetter {
	...
	public void setMaps() {
		System.out.println(this.gp.maps);
		this.gp.maps[0] = new Map(gp, 0, 23, 14);
	...
	public void setObject() {
		...
		var10000 = this.gp.obj[0][9];
		this.gp.getClass();
		var10000.worldY = 11 * gp.tileSize;
		...
		var10000 = this.gp.obj[0][16];
		this.gp.getClass();
		var10000.worldY = 12 * gp.tileSize;
