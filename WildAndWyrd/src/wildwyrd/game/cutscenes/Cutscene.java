...
public class Cutscene extends Entity {
	...
	public void setDialogue() {
		...
		case 12:
			...
			break;
		case 13:
			dialogues[dialogueSet][0] = new Dialoge("Rat","Who goes there!?",1);
			dialogues[dialogueSet][1] = new Dialoge("Alder","...!",port.image_Alder);
			dialogues[dialogueSet][2] = new Dialoge("Rat","Don't Move!!",1);
			dialogues[dialogueSet][3] = new Dialoge("Weasel","Please sir. I have nothing of value!",1);
			dialogues[dialogueSet][4] = new Dialoge("Rat","We'll see about that.",1);
			dialogues[dialogueSet][5] = new Dialoge("Rat","Show me what's in your bag.",1);
			dialogues[dialogueSet][6] = new Dialoge("Weasel","Only cloth and my traveling supplies sir, I am just a penniless merchant.",1);
			dialogues[dialogueSet][7] = new Dialoge("The rat took the sack and dug through it, keeping his eyes on the weasel.",1);
			dialogues[dialogueSet][8] = new Dialoge("Rat","A merchant?",1);
			dialogues[dialogueSet][9] = new Dialoge("Rat","What are you doing out here?",1);
			dialogues[dialogueSet][10] = new Dialoge("Rat","The Gowl knights have been tasked with finding spies in this wood.",1);
			dialogues[dialogueSet][11] = new Dialoge("Rat","What brings a merchant into here?",1);
			dialogues[dialogueSet][12] = new Dialoge("Rat","You're not trying to make a deal with them, are you?",1);
			dialogues[dialogueSet][13] = new Dialoge("Weasel","No Sir!",1);
			dialogues[dialogueSet][14] = new Dialoge("Weasel","I was just passing north, but I got lost.",1);
			dialogues[dialogueSet][15] = new Dialoge("The rat pulled out a large cloak from the sack.",1);
			dialogues[dialogueSet][16] = new Dialoge("Rat","Oh, lost are we!",1);
			dialogues[dialogueSet][17] = new Dialoge("Rat","What's with man-sized cloak?",1);
			dialogues[dialogueSet][18] = new Dialoge("Rat","I think you can wait right there...",1);
			dialogues[dialogueSet][19] = new Dialoge("Weasel","Wait!",1);
			dialogues[dialogueSet][20] = new Dialoge("Weasel","Let me explain!",1);
			dialogues[dialogueSet][21] = new Dialoge("Alder thought the rat was going to kill the weasel. Until...",1);
			dialogues[dialogueSet][22] = new Dialoge("Rat","Aagh!!",1);
			...
			dialogues[dialogueSet][27] = new Dialoge("Weasel","Uh. *Ahem!*",1);
			dialogues[dialogueSet][28] = new Dialoge("Jeb","M-My name is J-Jeb M-Ma'am.",1);
			dialogues[dialogueSet][29] = new Dialoge("Jeb","I-I am a merchant.",1);
			dialogues[dialogueSet][30] = new Dialoge("Jeb","I h-heard that there was a w-witch in these woods who might be in need of p-provisions to escape from the Gowls.",1);
			dialogues[dialogueSet][31] = new Dialoge("Jeb","I-In exchange for something magical perhaps?",1);
			...
			dialogues[dialogueSet][40] = new Dialoge("Jeb","Absolutely Ma'am!",1);
			dialogues[dialogueSet][41] = new Dialoge("Jeb","You can have the rest of my provisions for the other!",1);
			...
			dialogues[dialogueSet][45] = new Dialoge("Jeb","But, Ma'am.",1);
			dialogues[dialogueSet][46] = new Dialoge("Jeb","The Gowls are all over in that direction, with a human they will almost certainly arrest me.",1);
			dialogues[dialogueSet][47] = new Dialoge("Jeb","Even if we get to Forton, the mice propably won't be too eager to have him around.",1);
			...
			dialogues[dialogueSet][49] = new Dialoge("Jeb","No matter what you pay me that does not change the peril I would face if I took your request.",1);
			...
			dialogues[dialogueSet][54] = new Dialoge("Jeb","Child...",1);
			dialogues[dialogueSet][55] = new Dialoge("Jeb","You are the Scion!",1);
			dialogues[dialogueSet][56] = new Dialoge("Jeb","...We might be able to get through.",1);
			dialogues[dialogueSet][57] = new Dialoge("Jeb","But we will have to sneak around them.",1);
			dialogues[dialogueSet][58] = new Dialoge("Jeb","Better safe than sorry.",1);
