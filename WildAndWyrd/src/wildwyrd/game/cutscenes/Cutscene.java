...
public class Cutscene extends Entity {
	...
	public void setDialogue() {
		...
		case 14:
			...
			dialogues[dialogueSet][29] = new Dialoge("Sorcerer Fox","There might very well be something here.",1);
			dialogues[dialogueSet][30] = new Dialoge("Sorcerer Fox","There are illusions on this rock.",1);
			dialogues[dialogueSet][31] = new Dialoge("Sorcerer Fox","I'm dispelling them.",1);
			dialogues[dialogueSet][32] = new Dialoge("Sorcerer Fox","Get ready!",1);
			dialogues[dialogueSet][33] = new Dialoge("The sorcerer chanted and tapped the illusion with his staff.",1);
			...
			dialogues[dialogueSet][35] = new Dialoge("Sorcerer Fox","Aah!",1);
