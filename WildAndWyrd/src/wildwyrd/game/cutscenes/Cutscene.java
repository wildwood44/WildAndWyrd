...
public class Cutscene extends Entity {
	...
	public void setDialogue() {
		...
		case 14:
			...
			dialogues[dialogueSet][5] = new Dialoge("Jeb","I think I can see... six... no, seven of them.",port.image_Jeb);
			...
			dialogues[dialogueSet][13] = new Dialoge("Florence","There may be more further out there.",port.image_Florence);
			dialogues[dialogueSet][14] = new Dialoge("Kyla","In that case, I will need one to call for reinforcements.",port.image_Kyla);
			dialogues[dialogueSet][15] = new Dialoge("Kyla","Do you recognise any of the ones here?",port.image_Kyla);
			dialogues[dialogueSet][16] = new Dialoge("Jeb","Not at this distance but judging by their armour and ages it looks like a captain, scouts as well as what I think are squires with them.",port.image_Jeb);
			dialogues[dialogueSet][17] = new Dialoge("Jeb","Maybe they're educating them?",port.image_Jeb);
			dialogues[dialogueSet][18] = new Dialoge("Jeb","Wait!",port.image_Jeb);
			dialogues[dialogueSet][19] = new Dialoge("Jeb","The fox out in front! Look at his robes!",port.image_Jeb);
			dialogues[dialogueSet][20] = new Dialoge("Jeb","He's the sorcerer!",port.image_Jeb);
			dialogues[dialogueSet][21] = new Dialoge("Kyla","Florence.",port.image_Kyla);
			dialogues[dialogueSet][22] = new Dialoge("Kyla","Are you truly sure you want to leave with the boy?",port.image_Kyla);
			dialogues[dialogueSet][23] = new Dialoge("Florence","Yes.",port.image_Florence);
			dialogues[dialogueSet][24] = new Dialoge("Kyla","It won't be easy living in Forton.",port.image_Kyla);
			dialogues[dialogueSet][25] = new Dialoge("Kyla","The mice may not look at you favourably.",port.image_Kyla);
			dialogues[dialogueSet][26] = new Dialoge("Florence","I can live with that.",port.image_Florence);
			dialogues[dialogueSet][27] = new Dialoge("Kyla","...Fine then. Go.",port.image_Kyla);
			dialogues[dialogueSet][28] = new Dialoge("Kyla","It is time.",port.image_Kyla);
			dialogues[dialogueSet][29] = new Dialoge("Kyla","Everyone into the undergrowth.",port.image_Kyla);
			dialogues[dialogueSet][30] = new Dialoge("Kyla","I'll distract them until morning.",port.image_Kyla);
			dialogues[dialogueSet][31] = new Dialoge("Kyla","Keep out of sight until you're far from the cottage. And be wary of reinforcements within the woods!",port.image_Kyla);
			dialogues[dialogueSet][32] = new Dialoge("Alder, Florence and Jeb donned their enchanted cloaks and moved to hide in a dense bush.",1);
			dialogues[dialogueSet][33] = new Dialoge("Weasel","This is the place.",port.image_Gowl_Weasel);
			dialogues[dialogueSet][34] = new Dialoge("Rat","Where's Midge?",port.image_Gowl_Rat);
			dialogues[dialogueSet][35] = new Dialoge("Weasel","He was here.",port.image_Gowl_Weasel);
			dialogues[dialogueSet][36] = new Dialoge("Weasel","Midge!",port.image_Gowl_Weasel);
			dialogues[dialogueSet][37] = new Dialoge("Weasel","MIDGE!!",port.image_Gowl_Weasel);
			dialogues[dialogueSet][38] = new Dialoge("Sorcerer Fox","There might very well be something here.",1);
			dialogues[dialogueSet][39] = new Dialoge("Sorcerer Fox","There are illusions on this rock.",1);
			dialogues[dialogueSet][40] = new Dialoge("Sorcerer Fox","I'm dispelling them.",1);
			dialogues[dialogueSet][41] = new Dialoge("Sorcerer Fox","Get ready!",1);
			dialogues[dialogueSet][42] = new Dialoge("The sorcerer chanted and tapped the illusion with his staff.",1);
			dialogues[dialogueSet][43] = new Dialoge("The stone cracked glass and fell apart revealing the cottage in its true form to the world. As soon as it fell, the fox tumbled backwards, a green light enveloping him, not even giving him a chance to scream. In front of the shocked knights was Kyla, a dark green water like spell covered her hands and she slammed it into the ground. As the escapees fled their home they could hear the screams of their would-be hunters.",1);
			dialogues[dialogueSet][44] = new Dialoge("Sorcerer Fox","Aah!",1);
			break;
		}
	}
