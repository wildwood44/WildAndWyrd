...
public class NPC_Thay extends Entity {
	public NPC_Thay(GamePanel gp) {
		...
		contConditions[4] = false;
		contConditions[5] = false;
		contConditions[6] = false;
		contConditions[7] = false;
		setDialogue();
		setDialogueOptions();
	}
	...
	public void setDialogue() {
		...
		dialogues[2][1] = new Dialoge("Thay reached into his bag and pulled out a vial of black liquid. Phantom Cloak; a magic potion that erased a creature’s presence when in darkness. It was one of the many potions that brought patrons to the cottage. Alder never asked what they needed them for.", 1);
		...
		dialogues[7][5] = new Dialoge("Thay", "Unless they go through the rabbits tunnels.",1);
		...
		dialogues[8][9] = new Dialoge("Thay", "Best for you to stay within the burrows borders young one.",1);
	...
	public void setDialogueOptions() {
		...
		options[3] = "What can you tell me about the woods?";
		options[4] = "What can you tell me about the the mouse village?";
		options[5] = "What can you tell me about the river?";
		options[6] = "What can you tell me about the hill?";
